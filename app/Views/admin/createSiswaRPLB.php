    ...
    <div class="card shadow shadow-blue-500/50 mb-4 border-2" style="margin-top: 25px; padding: 20px;">
        <div class="container">
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary">Tambah Siswa XI RPL B</h4>
            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title fw-semibold"> Pendaftaran Siswa RPL B </h5>
            ...
            <form action="/AdminController/saveRPLB" method="post" enctype="multipart/form-data">
