...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 border-2" style="margin-top: 25px;">
        ...
        <div class="card-header py-3 border-0 d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?= base_url() ?>AdminController/editSiswaRPLB/<?= $siswab['slug']; ?>" class="btn btn-warning btn-sm">
                    <i class="fas fa-edit"></i> Edit
                </a>

                <form action="<?= base_url() ?>AdminController/deleteSiswaRPLB/<?= $siswab['id']; ?>" method="post" class="d-inline">
                    <?= csrf_field(); ?>
