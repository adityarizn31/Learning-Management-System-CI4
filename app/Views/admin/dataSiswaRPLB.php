    ...
    <div class="card shadow mt-3 border-2 border-primary">
        ...
        <div class="card-header py-3">
            <div class="d-sm-flex align-items-center justify-content-between" style="padding-top: 10px;">
                ...
                <a href="/AdminController/createSiswaRPLB/" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> Tambah Siswa B </a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <?php foreach ($rplb as $b) : ?>
                        <tr>
                            ...
                            <td><?= $b['nama_siswa']; ?></td>
                            <td><?= $b['kelas_siswa']; ?></td>
                            <td><a href="/admin/detailSiswaRPLB/<?= $b['slug']; ?>" class="btn btn-success">Detail</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
