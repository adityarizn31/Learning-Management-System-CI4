...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 border-2" style="margin-top: 25px; padding: 20px;">
        <div class="container">
            ...
            <form action="/AdminController/updateSiswaRPLC/<?= $rplc['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="fotolama" value="<?= $rplc['foto_siswa']; ?>">

                <div class="row">
                    <div class="mb-3">
                        <label for="nis_siswa" class="form-label fw-semibold"> NIS Siswa </label>
                        <input type="text" name="nis_siswa" id="nis_siswa" class="form-control text-black <?= (session('errors.nis_siswa')) ? 'is-invalid' : null ?>" autofocus value="<?= (old('nis_siswa')) ? old('nis_siswa') : $rplc['nis_siswa'] ?>" ?>
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="text" name="username_siswa" id="username_siswa" class="form-control text-black <?= (session('errors.username_siswa')) ? 'is-invalid' : null ?>" autofocus value="<?= (old('username_siswa')) ? old('username_siswa') : $rplc['username_siswa'] ?>" ?>
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="password" name="password_siswa" id="password_siswa" class="form-control text-black <?= (session('errors.password_siswa')) ? 'is-invalid' : null ?>" autofocus value="<?= (old('password_siswa')) ? old('password_siswa') : $rplc['password_siswa'] ?>" ?>
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_siswa" id="nama_siswa" class="form-control text-black <?= (session('errors.nama_siswa')) ? 'is-invalid' : null ?>" autofocus value="<?= (old('nama_siswa')) ? old('nama_siswa') : $rplc['nama_siswa'] ?>" ?>
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nohp_siswa" id="nohp_siswa" class="form-control text-black <?= (session('errors.nohp_siswa')) ? 'is-invalid' : null ?>" autofocus value="<?= (old('nohp_siswa')) ? old('nohp_siswa') : $rplc['nohp_siswa'] ?>" ?>
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="text" name="alamat_siswa" id="alamat_siswa" class="form-control text-black <?= (session('errors.alamat_siswa')) ? 'is-invalid' : null ?>" autofocus value="<?= (old('alamat_siswa')) ? old('alamat_siswa') : $rplc['alamat_siswa'] ?>" ?>
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <div class="col-sm-2 my-4">
                            <img src="/img/rplc/<?= $rplc['foto_siswa']; ?>" class="img-thumbnail img-preview" srcset="">
                        </div>
                    </div>
                </div>
