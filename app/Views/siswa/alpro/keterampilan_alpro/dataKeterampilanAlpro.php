    ...
    <div class="card shadow border-2 border-primary">
        ...
        <div class="card-header py-3">
            <div class="d-sm-flex align-items-center justify-content-between" style="padding-top: 10px;">
                ...
                <a href="<?= base_url() ?>AdminController/editKeterampilanAlpro/" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm">
                    <i class="fas fa-edit me-2"></i> Edit Quiz
                </a>
                <a href="<?= base_url() ?>AdminController/deleteKeterampilanAlpro/" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
