            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="container mb-3 align-items-center">
                        <div class="row">
                            <a href="/GuruController/editSiswaRPLB/<?= $rplb['slug']; ?>" class="btn btn-warning">Edit</a>

                            <form action="/GuruController/deleteSiswaRPLB/<?= $rplb['id']; ?>" method="delete" class="d-inline btn btn-danger mt-2">
                                <?= csrf_field(); ?>
