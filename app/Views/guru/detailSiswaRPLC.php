    ...
    <div class="card shadow mb-4 border-2">
        ...
        <div class="card-header py-3 border-0 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                <a href="/GuruController/editSiswaRPLC/<?= $siswac['slug']; ?>" class="btn btn-warning btn-sm mr-2">
                    <i class="fas fa-edit"></i> Edit
                </a>
                <form action="/GuruController/deleteSiswaRPLC/<?= $siswac['id']; ?>" method="post" class="d-inline m-0 p-0">
                    <?= csrf_field(); ?>
