                ...
                <div class="col">
                    ...
                    <div class="container mb-3 align-items-center">
                        <div class="row">
                            ...
                            <a href="/GuruController/editSiswaRPLC/<?= $rplc['slug']; ?>" class="btn btn-warning">Edit</a>

                            <form action="/GuruController/deleteSiswaRPLC/<?= $rplc['id']; ?>" method="post" class="d-inline btn btn-danger mt-2">
                                <?= csrf_field(); ?>
