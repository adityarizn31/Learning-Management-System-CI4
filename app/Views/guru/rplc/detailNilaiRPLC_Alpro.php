...
<div class="container mt-5">
    <h2 class="mb-4">Data Siswa dan Nilai Algoritma Pemrograman RPL C</h2>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= base_url() ?>GuruController/createNilaiSiswaC" class="btn btn-primary btn-sm">
            ...
            <?php foreach ($siswa_nilai as $sn): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url() ?>GuruController/createNilaiSiswaCModal" class="btn btn-info btn-sm">
